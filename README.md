...
A small program that randomly chooses wallpapers from your existing lively wallpapers.
...
* A config.json file for changing various things such as
  ...
  * The folder where your wallpapers are stored
  * Your monitors
  * The time between changing wallpapers
